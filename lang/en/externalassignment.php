...
$string['externalgrademaxnegativevalidation'] = 'External grade max. cannot be negative.';
...
$string['externallinkinvalidvalidation'] = 'Assignment link must be a valid URL, e.g. https://www.example.com/assignment.';
