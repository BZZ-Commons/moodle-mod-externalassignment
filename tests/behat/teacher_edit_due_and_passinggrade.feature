...
Feature: Edit an external assignment to add a due date and a passing grade
  In order to manage assignments effectively
  As a teacher
  I need to be able to edit an existing external assignment to add a due date and a
  passing grade

  This covers acceptance_tests.md section 3 ("Edit existing external assignment"), row d.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | externalassignment | C1     | Assignment without dates or grading | m999-editduepassing | https://www.example.com/assignment | 0          |

  Scenario: Editing an external assignment to add a due date and a passing grade
